...
QT_MOC_LITERAL(1, 14, 13), // "signalChanged"
...
QT_MOC_LITERAL(6, 52, 8) // "sendData"
    ...
    "SerialManager\0signalChanged\0\0data\0"
    "onReadyRead\0start\0sendData"
};
...
void SerialManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->onReadyRead(); break;
        case 2: _t->start(); break;
        case 3: _t->sendData((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialManager::signalChanged)) {
                *result = 0;
                return;
            }
        }
